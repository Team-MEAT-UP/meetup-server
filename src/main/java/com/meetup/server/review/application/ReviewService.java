...
public class ReviewService {
    ...
    public void createVisitedReview(UUID placeId, Long userId, VisitedReviewRequest visitedReviewRequest) {
        ...
        reviewWriter.saveVisitedReview(
                place,
                user,
                visitedReviewRequest.visitedTime(),
                visitedReviewRequest.socket(),
                visitedReviewRequest.seat(),
                visitedReviewRequest.quiet(),
                visitedReviewRequest.content());
    }
}
